      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-10 py-32 md:py-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center min-h-[100dvh]">
          ...
          <div className="hero-photo hidden lg:flex flex-col gap-5 py-32 relative">
            ...
            <div className="hero-photo-card absolute bottom-36 -left-8 bg-slate-card rounded-2xl px-5 py-4 border border-white/8 shadow-2xl" style={{ backdropFilter: 'blur(12px)' }}>
            ...
            <div className="hero-photo-card absolute top-36 -right-4 bg-slate-card rounded-2xl px-5 py-4 border border-gold/20 shadow-2xl" style={{ backdropFilter: 'blur(12px)' }}>
