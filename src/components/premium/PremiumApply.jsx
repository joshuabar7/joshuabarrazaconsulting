      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
          ...
          <div className="booking-right h-full">
            <div
              className="calendly-inline-widget w-full h-full rounded-3xl overflow-hidden border border-gold/15 shadow-2xl shadow-midnight/60"
              data-url={`${booking.calendlyUrl}?hide_gdpr_banner=1&background_color=1A1D2A&text_color=faf9f6&primary_color=C9A84C`}
              data-resize="true"
