        ...
        <div className="space-y-10 font-sans text-white/60 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 pl-2">
              <li><strong className="text-white/80">Booking information</strong> — your name, email address, and any information you provide when scheduling a session through Calendly.</li>
              <li><strong className="text-white/80">Application information</strong> — for The Launch Program, information you submit through our application form including name, email, grade level, and areas of interest. This is processed through Formspree.</li>
              <li><strong className="text-white/80">Payment information</strong> — when payments are processed, transaction data is handled by Stripe. We do not collect or store your card number, CVV, or raw payment details.</li>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div className="border border-white/8 rounded-xl p-4">
                <p className="font-sans font-bold text-white/80 text-sm mb-1">Formspree</p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 pl-2">
              <li><strong className="text-white/80">Essential cookies</strong> — required for the site to function, including storing your cookie consent preference.</li>
          ...
          <section>
            ...
            <p>
              We keep personal information for <strong className="text-white/80">one year from your last interaction</strong> with us.
