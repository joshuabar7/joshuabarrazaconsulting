      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 font-sans text-white/60 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="font-bold text-white/65 mb-2">The Launch Program (Free)</p>
            ...
            <p className="font-bold text-white/65 mb-2">JBC Premium (Paid)</p>
            <div className="space-y-3">
              <div className="border border-white/10 rounded-xl p-4">
                <p className="font-bold text-midnight/80">Starter Toolkit — $10</p>
              ...
              <div className="border border-white/10 rounded-xl p-4">
                <p className="font-bold text-midnight/80">ATS Bypass Kit — $15</p>
              ...
              <div className="border border-white/10 rounded-xl p-4">
                <p className="font-bold text-midnight/80">Full Consulting Package — $50</p>
              ...
              <div className="border border-white/10 rounded-xl p-4">
                <p className="font-bold text-midnight/80">Pro Package — $100</p>
          ...
          <section>
            ...
            <div className="border border-gold/20 bg-gold/5 rounded-xl p-4 mb-3">
              <p className="text-white font-bold mb-1">All sales are final. We do not offer refunds.</p>
              <p>
          ...
          <section>
            ...
            <div className="border border-white/10 rounded-xl p-4 bg-white/3">
              <p className="mb-3">
                <strong className="text-midnight/75">Career outcomes cannot be guaranteed.</strong> Our services are
